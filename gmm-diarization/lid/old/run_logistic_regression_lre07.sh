...
train_dir=exp/ivectors_train_new
test_dir=exp/ivectors_lre07_new
model_dir=exp/ivectors_train_new
train_utt2lang=data/train_lr_subset/utt2lang
test_utt2lang=data/lre07_new/utt2lang
prior_scale=1.0
