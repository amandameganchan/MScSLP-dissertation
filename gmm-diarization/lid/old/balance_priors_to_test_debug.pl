...
#print "train_lang_count: @{[ %train_count ]}";
#print "train_tot_utt: $train_tot";
...
#print "test_lang_count: @{[ %test_count ]}";
#print "test_tot_utt: $test_tot";
...
#print "test_lang_count with zeros: @{[ %test_count ]}";
...
#print "lang_dict: @idx_to_lang\n";

$priors = " [ ";
foreach $lang (@idx_to_lang) {
 #print "lang: $lang, scale: $scale\n";
 #print "test_count[lang]: $test_count{$lang} / train_count[lang]: $train_count{$lang}\n";
