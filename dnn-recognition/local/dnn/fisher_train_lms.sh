...
if [ $# != 2 ]; then
  echo "Usage: fisher_train_lms.sh <data-dir> <heldout_num>"
  exit 1;
fi 
...
text=$data_dir/train_all_asr/text
...
train_lm.sh --arpa --lmtype 3gram-mincount $dir $heldout_sent || exit 1;
