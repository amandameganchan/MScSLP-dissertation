...
num_threads=1
minibatch_size=512
dir=exp/enws_mono/nnet2_online/nnet_ms_a
...
local/dnn/run_nnet2_common_mono.sh --stage $stage
...
if [ $stage -le 6 ]; then
  ...
  lid/nnet2/train_multisplice_accel2.sh --stage $train_stage \
    ...
    data/enws_mono/train_hires_asr data/enws_mono/lang exp/enws_mono_fix/tri4a $dir  || exit 1;
