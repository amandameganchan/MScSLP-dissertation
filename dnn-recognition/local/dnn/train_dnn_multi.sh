...
#-------------------
# modified by Amanda for multilingual DNN-UBM dissertation experiment
...
utils/fix_data_dir.sh data/NEW_dnn_multi/train_all_asr

steps/make_mfcc.sh --cmd "$train_cmd" --mfcc-config conf/mfcc_asr.conf \
   data/NEW_dnn_multi/train_all_asr exp/dnn_multi/make_mfcc/train_all_asr $mfccdir/dnn_multi

utils/fix_data_dir.sh data/NEW_dnn_multi/train_all_asr
utils/validate_data_dir.sh data/NEW_dnn_multi/train_all_asr
...
utils/subset_data_dir.sh --first data/NEW_dnn_multi/train_all_asr 5000 data/NEW_dnn_multi/dev_and_test_asr
utils/subset_data_dir.sh --first data/NEW_dnn_multi/dev_and_test_asr 2500 data/NEW_dnn_multi/dev_asr
utils/subset_data_dir.sh --last data/NEW_dnn_multi/dev_and_test_asr 2500 data/NEW_dnn_multi/test_asr
rm -r data/NEW_dnn_multi/dev_and_test_asr

steps/compute_cmvn_stats.sh data/NEW_dnn_multi/dev_asr exp/dnn_multi/make_mfcc/dev_asr $mfccdir/dnn_multi
steps/compute_cmvn_stats.sh data/NEW_dnn_multi/test_asr exp/dnn_multi/make_mfcc/test_asr $mfccdir/dnn_multi

n=$[`cat data/NEW_dnn_multi/train_all_asr/segments | wc -l` - 5000]
utils/subset_data_dir.sh --last data/NEW_dnn_multi/train_all_asr $n data/NEW_dnn_multi/train_asr
steps/compute_cmvn_stats.sh data/NEW_dnn_multi/train_asr exp/dnn_multi/make_mfcc/train_asr $mfccdir/dnn_multi 
...
utils/subset_data_dir.sh --shortest data/NEW_dnn_multi/train_asr 13000 data/NEW_dnn_multi/train_asr_10k
local/dnn/remove_dup_utts.sh 50 data/NEW_dnn_multi/train_asr_10k data/NEW_dnn_multi/train_asr_10k_nodup
utils/subset_data_dir.sh --speakers data/NEW_dnn_multi/train_asr 30000 data/NEW_dnn_multi/train_asr_30k
...
steps/train_mono.sh --cmd "$train_cmd" \
  data/NEW_dnn_multi/train_asr_10k_nodup data/NEW_dnn_multi/lang exp/dnn_multi/mono0a 

steps/align_si.sh --cmd "$train_cmd" \
   data/NEW_dnn_multi/train_asr_30k data/NEW_dnn_multi/lang exp/dnn_multi/mono0a exp/dnn_multi/mono0a_ali

steps/train_deltas.sh --cmd "$train_cmd" \
    1000 8000 data/NEW_dnn_multi/train_asr_30k data/NEW_dnn_multi/lang exp/dnn_multi/mono0a_ali exp/dnn_multi/tri1

(utils/mkgraph.sh data/NEW_dnn_multi/lang_test exp/dnn_multi/tri1 exp/dnn_multi/tri1/graph
 steps/decode.sh --cmd "$decode_cmd" \
   exp/dnn_multi/tri1/graph data/NEW_dnn_multi/dev_asr exp/dnn_multi/tri1/decode_dev)&

steps/align_si.sh --cmd "$train_cmd" \
   data/NEW_dnn_multi/train_asr_30k data/NEW_dnn_multi/lang exp/dnn_multi/tri1 exp/dnn_multi/tri1_ali

steps/train_deltas.sh --cmd "$train_cmd" \
    1000 8000 data/NEW_dnn_multi/train_asr_30k data/NEW_dnn_multi/lang exp/dnn_multi/tri1_ali exp/dnn_multi/tri2

(utils/mkgraph.sh data/NEW_dnn_multi/lang_test exp/dnn_multi/tri2 exp/dnn_multi/tri2/graph
  steps/decode.sh --cmd "$decode_cmd" \
   exp/dnn_multi/tri2/graph data/NEW_dnn_multi/dev_asr exp/dnn_multi/tri2/decode_dev)&

steps/align_si.sh --cmd "$train_cmd" \
  data/NEW_dnn_multi/train_asr data/NEW_dnn_multi/lang exp/dnn_multi/tri2 exp/dnn_multi/tri2_ali

# Train tri3a, which is LDA+MLLT
steps/train_lda_mllt.sh --cmd "$train_cmd" \
   --splice-opts "--left-context=3 --right-context=3" \
   1500 12000 data/NEW_dnn_multi/train_asr data/NEW_dnn_multi/lang exp/dnn_multi/tri2_ali exp/dnn_multi/tri3a

(utils/mkgraph.sh data/NEW_dnn_multi/lang_test exp/dnn_multi/tri3a exp/dnn_multi/tri3a/graph 
  steps/decode.sh --cmd "$decode_cmd" \
   exp/dnn_multi/tri3a/graph data/NEW_dnn_multi/dev_asr exp/dnn_multi/tri3a/decode_dev)&

# Next we'll use fMLLR and train with SAT (i.e. on 
# fMLLR features)

steps/align_fmllr.sh --cmd "$train_cmd" \
  data/NEW_dnn_multi/train_asr data/NEW_dnn_multi/lang exp/dnn_multi/tri3a exp/dnn_multi/tri3a_ali 

steps/train_sat.sh  --cmd "$train_cmd" \
  2048 40960 data/NEW_dnn_multi/train_asr data/NEW_dnn_multi/lang exp/dnn_multi/tri3a_ali exp/dnn_multi/tri4a 

(utils/mkgraph.sh data/NEW_dnn_multi/lang_test exp/dnn_multi/tri4a exp/dnn_multi/tri4a/graph
  steps/decode_fmllr.sh --cmd "$decode_cmd" \
   exp/dnn_multi/tri4a/graph data/NEW_dnn_multi/dev_asr exp/dnn_multi/tri4a/decode_dev)&
...
local/dnn/run_nnet2_multisplice_multi.sh
